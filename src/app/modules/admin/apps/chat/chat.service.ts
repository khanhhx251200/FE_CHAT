...
export class ChatService {
    ...
    getChats(): Observable<any> {
        ...
        return this.apiHelper.get(Constant.CHAT.GET_MESSAGE).pipe(
            tap((response: Chat[]) => {
    ...
    getContact(id: string): Observable<any> {
        return this.apiHelper
            .get('api/apps/chat/contacts', { params: { id } })
            .pipe(
    ...
    getContacts(): Observable<any> {
        return this.apiHelper.get(Constant.USER.GET_USER_SUMMARIES).pipe(
            tap((response: Contact[]) => {
    ...
    getProfile(): Observable<any> {
        return this.apiHelper.get(Constant.USER.GET_ME).pipe(
    ...
    getChatById(id: string): Observable<any> {
        return this.apiHelper
            .get('api/apps/chat/chat', { params: { id } })
            .pipe(
                map((chat) => {
                    // Update the chat
    ...
    getMessage(senderId: string, recipientId: string): Observable<any> {
        return this.apiHelper.get(Constant.CHAT.GET_MESSAGE + `/${senderId}/${recipientId}`);
    }

    getChatRoomId(senderId: string, recipientId: string): Observable<any> {
        return this.apiHelper.get(Constant.CHAT.GET_CHAT_ROOM+`/${senderId}/${recipientId}`);
    }
}
